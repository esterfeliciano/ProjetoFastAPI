...
set -gx VIRTUAL_ENV /home/esterfeliciano/estagio/ProjetoFastAPI/fast_zero/Backend/.venv
...
if test -n fast-zero-py3.12
    set -gx VIRTUAL_ENV_PROMPT fast-zero-py3.12
else
